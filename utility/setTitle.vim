...
func Set_sh_Title()
	...
	call append(3,"#")
	call append(4,"# Copyright (C) 2018-2023 Yuan.Jin  <jinyuan@technomous.com.cn>. All Rights Reserved.")
	call append(5,"#")
	call append(6,"# History:")
	call append(7,"#    ".strftime("%Y/%m/%d")." - [Yuan.Jin] Created file")
	call append(8,"#")
	call append(9,"# Maintainer: Yuan.Jin <jinyuan@technomous.com.cn>")
...
func Set_py_Title()
	...
	call append(4,"#")
	call append(5,"# Copyright (C) 2018-2023 Yuan.Jin  <jinyuan@technomous.com.cn>. All Rights Reserved.")
	call append(6,"#")
	call append(7,"# History:")
	call append(8,"#    ".strftime("%Y/%m/%d")." - [Yuan.Jin] Created file")
	call append(9,"#")
	call append(10,"# Maintainer: Yuan.Jin <jinyuan@technomous.com.cn>")
...
func Set_c_common_Title()
	...
	call append(2," *")
	call append(3," * Copyright (C) 2018-2023 Yuan.Jin  <jinyuan@technomous.com.cn>. All Rights Reserved.")
	call append(4," *")
	call append(5," * History:")
	call append(6," *    ".strftime("%Y/%m/%d")." - [Yuan.Jin] Created file")
	call append(7," *")
	call append(8," * Maintainer: Yuan.Jin <jinyuan@technomous.com.cn>")
...
func Set_md_Title()
	...
	call append(1,"- Maintainer: eric <jinyuan@technomous.com.cn>")
...
func Set_vim_Title()
	...
	call append(1,"\"")
	call append(2,"\" Copyright (C) 2018-2023 eric  <jinyuan@technomous.com.cn>. All Rights Reserved.")
	call append(3,"\"")
	call append(4,"\" Maintainer: eric <jinyuan@technomous.com.cn>")
